...
public class ObrolanAdapter extends RecyclerView.Adapter<ObrolanAdapter.ObrolanViewHolder>{
    ...
    public ObrolanViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = View.inflate(activity, R.layout.activity_obrolan_holder, null);
    ...
    public void onBindViewHolder(ObrolanViewHolder holder, int position) {
        ...
        if (obrolanModel.isKontenMilikku()){
...
//        }
    ...
    public class ObrolanViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ObrolanViewHolder(View itemView){
            super(itemView);
            txtPenerimaKonten = (TextView) itemView.findViewById(R.id.txt_penerima_konten_chat);
            txtPengirimKonten = (TextView) itemView.findViewById(R.id.txt_pengirim_konten_chat);
            imgPenerima = (ImageView) itemView.findViewById(R.id.img_penerima_image);
            imgPengirim = (ImageView) itemView.findViewById(R.id.img_pengirim_image);
            avatarPenerima = (CircleImageView) itemView.findViewById(R.id.img_avatar_penerima);
            rlPenerima = (RelativeLayout) itemView.findViewById(R.id.rl_penerima_chat);
            rlPengirim = (RelativeLayout) itemView.findViewById(R.id.rl_pengirim_chat);
            txtPenerimaStatus = (TextView) itemView.findViewById(R.id.txt_penerima_status);
            txtPengirimStatus = (TextView) itemView.findViewById(R.id.txt_pengirim_status);
            //event click
        ...
        public void onClick(View v) {
            if (v == imgPenerima || v == imgPengirim){
                Intent intent = new Intent(activity, TampilGambarActivity.class);
