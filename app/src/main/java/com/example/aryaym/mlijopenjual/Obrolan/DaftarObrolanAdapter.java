...
public class DaftarObrolanAdapter extends RecyclerView.Adapter<DaftarObrolanAdapter.DaftarObrolanViewHolder>{
                    ...
                    if (dataSnapshot != null){
                        for (DataSnapshot dataObrolan : dataSnapshot.getChildren()){
                            ...
                            if (count <= listUid.size()){
                                ...
                                String key = "";
                                if (obrolanModel.isKontenMilikku()){
                                    key = obrolanModel.getPenerima();
                                }else {
                                    key = obrolanModel.getPengirim();
                                }
    ...
    public TextView txtNamaPenerima, txtKonten, txtWaktu;
        ...
        public DaftarObrolanViewHolder(View itemView) {
            ...
            imgAvatar = (ImageView) itemView.findViewById(R.id.img_obrolan_avatar);
            txtNamaPenerima = (TextView) itemView.findViewById(R.id.txt_nama_penerima);
            txtKonten = (TextView) itemView.findViewById(R.id.txt_obrolan_konten);
            txtWaktu =  (TextView) itemView.findViewById(R.id.txt_waktu_obrolan);
        }
    }
}
